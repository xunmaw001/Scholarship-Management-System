<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="奖金名称" prop="jiangjinmingcheng">
          <el-input v-model="ruleForm.jiangjinmingcheng" 
              placeholder="奖金名称" clearable  :readonly="ro.jiangjinmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="奖金名称" prop="jiangjinmingcheng">
              <el-input v-model="ruleForm.jiangjinmingcheng" 
                placeholder="奖金名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="奖金类型" prop="jiangjinleixing">
          <el-input v-model="ruleForm.jiangjinleixing" 
              placeholder="奖金类型" clearable  :readonly="ro.jiangjinleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="奖金类型" prop="jiangjinleixing">
              <el-input v-model="ruleForm.jiangjinleixing" 
                placeholder="奖金类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="奖金金额" prop="jiangjinjine">
          <el-input v-model="ruleForm.jiangjinjine" 
              placeholder="奖金金额" clearable  :readonly="ro.jiangjinjine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="奖金金额" prop="jiangjinjine">
              <el-input v-model="ruleForm.jiangjinjine" 
                placeholder="奖金金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="审核意见" prop="shenheyijian">
          <el-input v-model="ruleForm.shenheyijian" 
              placeholder="审核意见" clearable  :readonly="ro.shenheyijian"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="审核状态" prop="shenhezhuangtai">
          <el-select v-model="ruleForm.shenhezhuangtai" placeholder="请选择审核状态">
            <el-option
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	jiangjinmingcheng : false,
	jiangjinleixing : false,
	gonghao : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jiangjinmingcheng'){
            this.ruleForm.jiangjinmingcheng = obj[o];
	    this.ro.jiangjinmingcheng = true;
            continue;
          }
          if(o=='jiangjinleixing'){
            this.ruleForm.jiangjinleixing = obj[o];
	    this.ro.jiangjinleixing = true;
            continue;
          }
          if(o=='gonghao'){
	    ...
	    this.ro.jiaoshixingming = true;
          ...
          if(o=='jiangjinjine'){
            this.ruleForm.jiangjinjine = obj[o];
	    this.ro.jiangjinjine = true;
            continue;
          }
          if(o=='shenqingliyou'){
    ...
    gonghaoChange () {
      this.$http({
        url: `follow/fudaoyuan/gonghao?columnValue=`+ this.ruleForm.gonghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jiaowushenhe/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiaowushenheCrossAddOrUpdateFlag = false;
                  this.parent.search();
