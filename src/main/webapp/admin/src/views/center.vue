  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='fudaoyuan'"  label="教师姓名" prop="jiaoshixingming">
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='fudaoyuan'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='fudaoyuan'"  label="职称" prop="zhicheng">
